...
export const handler = async (client, args) => {
    ...
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.pools.getAddress(address, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-address-networks-onchain-pools.mjs.map
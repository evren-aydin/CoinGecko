...
const handler = async (client, args) => {
    ...
    return (0, types_1.asTextContentResult)(await (0, filtering_1.maybeFilter)(args, await client.onchain.networks.pools.getAddress(address, body)));
};
exports.handler = handler;
exports.default = { metadata: exports.metadata, tool: exports.tool, handler: exports.handler };
//# sourceMappingURL=get-address-networks-onchain-pools.js.map
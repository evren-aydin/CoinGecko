...
export const handler = async (client, args) => {
    ...
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.pools.info.get(pool_address, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-pools-networks-onchain-info.mjs.map
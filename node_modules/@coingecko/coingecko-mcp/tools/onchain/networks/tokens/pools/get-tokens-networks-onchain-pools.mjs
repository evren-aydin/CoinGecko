...
export const handler = async (client, args) => {
    ...
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.tokens.pools.get(token_address, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-tokens-networks-onchain-pools.mjs.map
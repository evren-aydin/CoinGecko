...
export const handler = async (client, args) => {
    ...
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.tokens.getAddress(address, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-address-networks-onchain-tokens.mjs.map
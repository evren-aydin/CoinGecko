...
export const handler = async (client, args) => {
    ...
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.tokens.topHolders.get(address, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-tokens-networks-onchain-top-holders.mjs.map
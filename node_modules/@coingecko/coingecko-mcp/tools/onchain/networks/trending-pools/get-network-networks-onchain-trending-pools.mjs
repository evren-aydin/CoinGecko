...
export const handler = async (client, args) => {
    ...
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.trendingPools.getNetwork(network, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-network-networks-onchain-trending-pools.mjs.map
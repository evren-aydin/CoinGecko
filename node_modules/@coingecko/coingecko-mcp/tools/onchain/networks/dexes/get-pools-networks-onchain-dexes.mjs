...
export const handler = async (client, args) => {
    const { dex, ...body } = args;
    return asTextContentResult(await maybeFilter(args, await client.onchain.networks.dexes.getPools(dex, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-pools-networks-onchain-dexes.mjs.map
...
export const handler = async (client, args) => {
    const { addresses, ...body } = args;
    return asTextContentResult(await maybeFilter(args, await client.onchain.simple.networks.tokenPrice.getAddresses(addresses, body)));
};
export default { metadata, tool, handler };
//# sourceMappingURL=get-addresses-networks-simple-onchain-token-price.mjs.map
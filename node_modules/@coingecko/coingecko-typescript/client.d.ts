...
export declare class Coingecko {
    ...
    protected proKeyAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    protected demoKeyAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    /**
